 ...
 * web engine registers, the signaling server redelivers the held ring
 * (deliverPendingRing), and the in-app answer flow takes over. DECLINE just
 * dismisses — the caller's no-answer window handles the rest honestly.
