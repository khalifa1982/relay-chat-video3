...
| Vitest suite (signaling, paging/redelivery, persistent-rejoin, conference-history, active-speaker layout, filters, auth, v2 routers, DND, passcode, biometric, geo, recording, inbound-email, contacts, groups, mute, typing, auto-update, auto-PiP, …) | **770 passing / 1 skipped** | `server/**/*.test.ts`, `client/src/lib/**/*.test.ts`, `client/src/app/**/*.test.ts`, `client/src/pages/**/*.test.ts` |
